...
public class GmailApiQuickstart {
  ...
  private static final String CLIENT_SECRET_PATH = "client_secret_959870656256-p84fk684ginq4ohnf5n9j5n1maplete6.apps.googleusercontent.com.json";

  private static GoogleClientSecrets clientSecrets;

  public static void main (String [] args) throws IOException {
    HttpTransport httpTransport = new NetHttpTransport();
   // JsonFactory jsonFactory1 = new JacksonFactory();
    ...
    for (Thread thread : threads) {
      ...
      System.out.println("Thread ID: " + thread.getId() + thread.getClassInfo());
    }
  }
